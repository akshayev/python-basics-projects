# Python Basics - Data Engineering Journey

## About
This repository contains my daily Python practice projects as I learn data engineering from scratch.

## Projects

### Day 1: Freelance Pay Calculator
**File:** `d1 The Freelancer Pay Calculator.py`

A simple calculator that computes freelancer payments with tax deductions.

**Features:**
- Takes freelancer name, hourly rate, and hours worked as input
- Calculates gross payment
- Applies 10% tax deduction
- Displays detailed payment breakdown
